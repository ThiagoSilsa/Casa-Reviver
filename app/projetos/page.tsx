...
import { ArrowRight, BookOpen, Heart, Users, Mic, Shield, Sparkles, Calendar, Gift } from 'lucide-react';
  ...
  const projetos = [
    {
      ...
      imagem: 'https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: BookOpen,
      cor: 'casa-azul'
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/1556665/pexels-photo-1556665.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Heart,
      cor: 'casa-laranja'
    },
    {
    ...
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/3321793/pexels-photo-3321793.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Mic,
      cor: 'casa-amarelo'
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/3280130/pexels-photo-3280130.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Shield,
      cor: 'casa-laranja'
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Sparkles,
      cor: 'casa-azul'
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/1749900/pexels-photo-1749900.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Gift,
      cor: 'casa-roxo'
    },
    {
      ...
      imagem: 'https://images.pexels.com/photos/3646372/pexels-photo-3646372.jpeg?auto=compress&cs=tinysrgb&w=500',
      icon: Calendar,
      cor: 'casa-amarelo'
    }
  ];
      ...
      <section className="bg-gradient-to-r from-[var(--casa-laranja)] to-[var(--casa-roxo)] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            8 projetos transformando vidas e construindo um futuro melhor para nossa comunidade
          </p>
        </div>
      </section>
              ...
              return (
                <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className="relative overflow-hidden rounded-t-lg">
                    ...
                    />
                    <div className={`absolute top-4 right-4 w-12 h-12 bg-[var(--${projeto.cor})] rounded-full flex items-center justify-center`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-[var(--casa-laranja)] mb-2">200+</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-[var(--casa-azul)] mb-2">8</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-[var(--casa-roxo)] mb-2">365</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-[var(--casa-amarelo)] mb-2">∞</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/seja-voluntario">
              <Button size="lg" className="bg-white text-[var(--casa-azul)] hover:bg-gray-100 text-lg px-8 py-4">
                Seja Voluntário
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <Link href="/contato">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[var(--casa-azul)] text-lg px-8 py-4">
                Entre em Contato
              </Button>
            </Link>
          </div>
